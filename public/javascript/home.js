...
function griid() {
    box.forEach(el => {
        ...
        el.onmouseover = function() {
            el.firstElementChild.lastElementChild.style.cssText = "display : inline-flex;"
            
        };
        el.onmouseout = function() {
            el.firstElementChild.lastElementChild.style.cssText = "display : none;"
        };
    });
    list.style.backgroundColor = "#fff";
    grid.style.backgroundColor = "#aaaaaa4a";
    addcart.forEach(el => {
        el.style.cssText = "display : none; width : 80%; top: 60%;right : 6%;"
    });
